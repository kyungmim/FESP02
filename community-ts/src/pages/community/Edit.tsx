...
import { ObjResponse, UpDataItem } from "types/community";
...
function Edit() {
  ...
  const onSubmit: SubmitHandler<UpDataItem> = async (formData) => {
    try {
  ...
  return (
    <main className="min-w-[320px] p-4">
      ...
      <section className="mb-8 p-4">
        <form onSubmit={handleSubmit((dataItem) => onSubmit(dataItem))}>
          <div className="my-4">
